...
<form style="margin-top: 10%"class="codehim-form" action="ResetPasswordImpl.jsp" method="post" onsubmit="return validate();">
   ...
   <input type="password" name="psw1"id="firstpsw" class="cm-input" placeholder="Enter your username">
   <label for="pass"><i class="fa fa-lock"></i> Confirm Password:</label>
   <input name="psw2" id="secondpsw" type="password" class="cm-input"  placeholder="Enter your password">
   <span style="color:red;" id="msg"></span>
   <button type="submit" class="btn-login  gr-bg">submit</button>
</form>
</body>
